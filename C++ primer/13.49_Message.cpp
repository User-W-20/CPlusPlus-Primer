...
//		f->remMsg(&lhs);
//	std::cout << "Remove message from folders" << std::endl;
//
...
//
//	std::cout << "Message members swaped" << std::endl;
//
//	for (auto f : lhs.folders)
//		f->addMsg(&lhs);
...
//	folders = rhs.folders;
//	std::cout << "Message members assgined" << std::endl;
//	add_to_Folders(rhs);
//	}return *this;
//}
//
...
//	for (auto m : lhs.msgs)
//		m->remFldr(&lhs);
//	std::cout << "clear folder" << std::endl;
//
//	for (auto m : rhs.msgs)
//		m->remFldr(&rhs);
//	std::cout << "clear folder" << std::endl;
...
//	std::cout << "Folder members swaped" << std::endl;
//
//	for (auto m : lhs.msgs)
//		m->addFldr(&lhs);
//	std::cout << "Added messages to folder" << std::endl;
//
//}
//
...
//		name = rhs.name;
//		msgs = rhs.msgs;
//		std::cout << "Folder members assigned" << std::endl;
//		add_to_Message(rhs);
//	}
//	return *this;
//}
